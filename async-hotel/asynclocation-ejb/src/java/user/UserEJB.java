...
//    public int terminerInterimUtilisateur(String ref) throws Exception;
    ...
    public void createUploadedPjService(String iddossier, HashMap<String, String> listeVal, Iterator it, String nomtable, String nomprocedure, String mere, String Smapping, String id) throws Exception;
