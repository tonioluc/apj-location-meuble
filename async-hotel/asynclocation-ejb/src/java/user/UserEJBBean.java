...
import utilisateur.UtilisateurInterim;
...
public class UserEJBBean implements UserEJB {
    ...
    String type;
    CNAPSUser cnapsUser;
    String home_page = "reservation/reservation-calendrier-v2.jsp";
    String idDirection;
...
//    }
    ...
    public Object[] getData(ClassMAPTable e, String[] colInt, String[] valInt, Connection c, String apresWhere)
        ...
        if (c == null) {
            return CGenUtil.rechercherPrecis(e, colInt, valInt, null, apresWhere);
        }
        return CGenUtil.rechercherPrecis(e, colInt, valInt, c, apresWhere);
    }
...
//                return o;
    ...
    @Override
    public void createUploadedPjService(String iddossier, HashMap<String, String> listeVal, Iterator it,
                                        String nomtable, String nomprocedure, String mere, String Smapping, String id) throws Exception {
        try {
            UploadService.createUploadedPj(iddossier, u.getTuppleID(), listeVal, it, nomtable, nomprocedure, mere, Smapping, id);
        } catch (Exception ex) {
            ex.printStackTrace();
            throw ex;
        }
    ...
    public String getTraduction(String mot){
        String result = mot;
        if (this.getLangue().equalsIgnoreCase("fr")==false){
