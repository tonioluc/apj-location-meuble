...
public class As_BonDeCommande_Fille extends ClassFille{
    ...
    public FactureFournisseurDetails genererFactureFille() throws Exception{
        try {
            FactureFournisseurDetails f = new FactureFournisseurDetails();
            f.setIdProduit(this.getProduit());
            f.setQte(this.getQuantite());
            f.setPu(this.getPu());
            f.setMontant(this.getMontant());
            f.setTva(this.getTva());
            f.setRemises(this.getRemise());
            f.setIdDevise(this.getIdDevise());
            f.setTauxDeChange(this.getTauxDeChange());
            f.setMontantTva(this.getMontantTva());
            f.setMontantHT(this.getMontantHT());
            f.setMontantTTC(this.getMontantTTC());
            return f;
        } catch (Exception e) {
