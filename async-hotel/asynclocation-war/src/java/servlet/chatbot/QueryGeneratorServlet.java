...
public class QueryGeneratorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if(log){
                aiResponse = ChatBot.callGenerativeAI(StaticQuery.dateToday+" "+StaticQuery.queryType+" "+message, ConstanteAsync.API_URL);
                ...
                if(type.equals("saisie")){
                    ...
                    aiResponse = ChatBot.callGenerativeAI(StaticQuery.dateToday+" "+StaticQuery.queryDB+" "+message, ConstanteAsync.API_URL);
