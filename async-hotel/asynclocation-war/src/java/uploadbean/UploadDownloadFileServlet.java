...
//            u.createUploadedPjService(iddossier, params, it, params.get("nomtable"), params.get("procedure"), params.get("id"));
            ...
            if ( params.get("classe") != null && !params.get("classe").isEmpty() && !params.get("classe").equalsIgnoreCase("null")) {
                u.createUploadedPjService(iddossier, params, it, params.get("nomtable"), params.get("procedure"), mere, params.get("classe"), id);
            }else u.createUploadedPjService(iddossier, params, it, params.get("nomtable"), params.get("procedure"), mere);
