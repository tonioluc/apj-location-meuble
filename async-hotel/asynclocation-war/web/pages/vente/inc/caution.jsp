...
<%
  try{
    ...
    String listeCrt[] = {};
    String listeInt[] = {};
    //String libEntete[] = {"id","idreservation","modepaiement","pct_applique", "referencepaiement","daty","montantgrp"};
...
<div class="box-body">
  <%
    //String libEnteteAffiche[] =  {"id","R&eacute;servation","Mode de paiement","Taux Appliqu&eacute;","R&eacute;f&eacute;rence Paiement","Date", "Montant"};
