...
<% try{ 
    ...
    pr.getFormu().getChamp("idMagasinArrive").setLibelle("Magasin d'arriv&eacute;");
    ...
    String libEnteteAffiche[] = {"id","d&eacute;signation","Magasin De D&eacute;part","Magasin D'Arriv&eacute;","Date","&Eacute;tat"};
