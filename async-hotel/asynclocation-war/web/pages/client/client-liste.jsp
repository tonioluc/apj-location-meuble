...
<% try{ 
    ...
    String listeCrt[] = {"id","nom","telephone","mail","adresse","representant","remarque"};
    String listeInt[] = {};
    String libEntete[] = {"id","nom","telephone","mail","adresse","representant","remarque"};
    ...
    pr.getFormu().getChamp("representant").setLibelle("Repr&eacute;sentant");
    ...
    String libEnteteAffiche[] = {"ID", "Nom", "T&eacute;lephone","Adresse e-mail","Adresse","Repr&eacute;sentant","Remarque"};
