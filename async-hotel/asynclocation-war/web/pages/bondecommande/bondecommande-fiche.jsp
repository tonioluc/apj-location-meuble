                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            %>
                            <% if(etat >= 11) {%>
                             <a class="btn btn-info pull-right"  href="<%=(String) session.getValue("lien") + "?but=bondecommande/apresLivraisonCommande.jsp&id=" + id%>"style="margin: 5px 10px 0 0">Livrer</a>
                            <a class="btn btn-primary pull-right"  href="<%=(String) session.getValue("lien") + "?but=facturefournisseur/facturefournisseur-saisie.jsp&idbc=" + id%>">Facturer</a>
                             <% } %>
