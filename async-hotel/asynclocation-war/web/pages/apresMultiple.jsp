...
<html>
    ...
    <% }
        if (acte != null && acte.compareToIgnoreCase("insertFille") == 0) {
                ...
                String idm = u.createObjectFilleMultiple(idMere, colonneMere, cfille);
        %>
    
    <script language="JavaScript"> document.location.replace("<%=lien%>?but=<%=bute%>&id=<%=idm%>");</script>
...
%>
        ...
        if (acte.compareToIgnoreCase("deleteFille") == 0) {
            ...
            u.deleteObjectMultiple(cmere, cfille);
        }
        /**
         * ********************************************
         */
