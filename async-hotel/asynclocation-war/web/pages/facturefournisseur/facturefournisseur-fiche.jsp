                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-secondary pull-right" href="<%= lien + "?but=facturefournisseur/liaison-facture-fournisseurs.jsp&id=" + id%>" style="margin-right: 10px;">Lier Frais divers</a>
                            <a class="btn btn-secondary pull-right"  href="<%= lien + "?but="+ pageRepartition +"&id=" + id%>" style="margin-right: 10px">R&eacute;partition frais divers</a>
                            <% }
                            %>
