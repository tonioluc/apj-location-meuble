...
<%
    try {
        ...
        affichage.Champ.setPageAppelComplete(pi.getFormufle().getChampFille("idProduit"),"annexe.ProduitLib","id","PRODUIT_LIB","kilometrage","idvoiture");
        ...
        pi.getFormufle().getChamp("kilometrage_0").setLibelle("Kilom&egrave;trage");
