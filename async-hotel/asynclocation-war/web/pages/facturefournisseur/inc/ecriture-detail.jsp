...
<%
    ...
    String listeCrt[] = {};
    String listeInt[] = {};
    String libEntete[] = {"id", "numero","journal", "compte","daty","remarque", "debit", "credit"};
...
<div class="box-body">
    <%
         String libEnteteAffiche[] =  {"ID", "Libell&eacute; de compte","Journal",  "Compte","Date","Remarque",  "D&eacute;bit", "Cr&eacute;dit"};
