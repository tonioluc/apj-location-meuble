...
<%
    try {
        ...
        if (acte != null && acte.compareToIgnoreCase("replacement") == 0) {
            ...
            ReservationDetails [] filles = new ReservationDetails[cfille.length];
            for (int i = 0; i < cfille.length; i++) {
                cfille[i].setNomTable(nomtable);
                filles[i] = (ReservationDetails) cfille[i];
            }
            Reservation tempo = (Reservation) cmere;
            idmere = tempo.remplacant(u, filles);
            /*
