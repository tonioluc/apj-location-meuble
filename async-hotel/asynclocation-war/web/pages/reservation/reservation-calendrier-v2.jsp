...
<%
    try{
        ...
        EtatReservationDetails eta=new EtatReservationDetails (debutEtFinDeSemaine[0],debutEtFinDeSemaine[1]);
        ...
        <div class="row">
            <div class="calendar-container">
                <div class="calendar-header">
                    ...
                    <div class="legend-container" style="display:flex; gap:20px; align-items:center; margin-left:20px;">
                        <div style="display:flex; align-items:center; gap:6px;">
                            <div style="width:34px; height:14px; background-color:#c92438; border-radius:3px;"></div>
                            <span style="font-size:14px;">Boucl&eacute;e</span>
                        </div>
                        <div style="display:flex; align-items:center; gap:6px;">
                            <div style="width:34px; height:14px; background-color:#5dde84; border-radius:3px;"></div>
                            <span style="font-size:14px;">Exp&eacute;di&eacute;e</span>
                        </div>
                        <div style="display:flex; align-items:center; gap:6px;">
                            <div style="width:34px; height:14px; background-color:#decb5d; border-radius:3px; border:1px solid #ccc;"></div>
                            <span style="font-size:14px;">&Agrave; pr&eacute;parer</span>
                        </div>
                    </div>
                    ...
                    <div class="calendar-row">
                        ...
                        %>
                            <% if (j<listeDate.length){
                                ReservationLib [] reservations = eta.getByDate(listeDate[j]);
                            ...
                            <% if(reservations!=null) {%>
                                ...
                                <div class="calendar-cell" <%=styleCalendarCell%>>
                                    ...
                                    <% for (int k = 0; k < 3 && k<reservations.length; k++) {%>
                                        <div onclick="ouvrirModal(event,'moduleLeger.jsp?but=reservation/reservation-fiche.jsp&id=<%=reservations[k].getId()%>','modalContent')" class="event">
...
<%--                                            <div class="event-hours">14:00</div>--%>
                                    ...
                                    <% if (reservations.length>3){%>
                                        <button onclick="ouvrirModal(event,'moduleLeger.jsp?but=reservation/inc/reservation-calendrier-details.jsp&daty=<%=listeDate[j]%>','modalContent')" class="btn btn-primary" style="width: 100% !important;">+<%=reservations.length-3%> de plus</button>
                                    <%}%>
                                </div>
                            <% } else { %>
