...
<%
    ...
    String listeCrt[] = {"id","libelle", "reference", "unite","idcategorie", "pu"};
    String listeInt[] = {"pu"};
    String libEntete[] = {"id", "reference","libelle","image", "categorieingredient", "unite", "pu", "quantiteparpack"};
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <%  String libEnteteAffiche[] =  {"ID","R&eacute;f&eacute;rence", "Article", "Image", "Cat&eacute;gorie Produit","Unit&eacute;", "Prix unitaire","Quantit&eacute;"};
