...
//    pc.getChampByName("puVenteAutreDevise").setLibelle("PU Vente Autre Devise");
    ...
    pc.getChampByName("puAchatUsd").setVisible(false);
    pc.getChampByName("puAchatEuro").setVisible(false);
    pc.getChampByName("puAchatAutreDevise").setVisible(false);
    pc.getChampByName("puVenteUsd").setVisible(false);
    pc.getChampByName("puVenteEuro").setVisible(false);
    pc.getChampByName("puVenteAutreDevise").setVisible(false);
    
    String pageModif = "produits/as-ingredients-modif.jsp";
