...
<%
    ...
    String listeCrt[] = {"id","idProduitLib","idTypeProduitLib","idMagasinLib","quantite","entree","sortie","reste","idUniteLib"};
    String listeInt[] = {};
    ...
    pr.setTitre("Page choix d'un produit");
    ...
    //pr.getFormu().getChamp("dateDernierMouvement1").setDefaut(utilitaire.Utilitaire.dateDuJour());
    //pr.getFormu().getChamp("dateDernierMouvement2").setLibelle("Date max");
    //pr.getFormu().getChamp("dateDernierMouvement2").setDefaut(utilitaire.Utilitaire.dateDuJour());
    
    String[] colSomme = null;
    pr.creerObjetPage(libEntete, colSomme);
    String libEnteteAffiche[] = {"id","Produit","Cat&eacute;gorie","Magasin","Prix","quantit&eacute;","entr&eacute;e","sortie","reste","Unit&eacute;"};
