...
<header class="main-header" style="position: fixed; left: 0; right: 0;">
    <!-- Logo -->
            <a style="background-color:#ffffff; height:50px;" href="<%=lien%>?but=<%=home_page%>" class="logo">
                    ...
                    <span class="logo-lg">  <img style="width: 90px;height: 25px;" src="${pageContext.request.contextPath}/assets/img/logo.png"/> </span>
            </a>
...
<div class="navbar-custom-menu">
    <ul class="nav navbar-nav d-flex">
        <!-- Notifications -->
        <li class="dropdown user user-menu" id="notifrefresh" style="display: flex; align-items: center; margin-right: 20px;">
            <!-- notification.js va injecter l'icône et dropdown -->
        </li>

        <!-- Utilisateur + déconnexion -->
        <li class="dropdown user user-menu">
                            <span class="btn btn-tertiary btn-small" style="display: flex; align-items: center; cursor: pointer;" id="user-login-span">
    ...
    <script language="JavaScript">
        var lien = '<%=(String) session.getValue("lien")%>';
    </script>