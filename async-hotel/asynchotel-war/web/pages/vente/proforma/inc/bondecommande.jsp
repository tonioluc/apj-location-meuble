...
<%
  try {
    ...
    String listeCrt[] = {};
    String listeInt[] = {};
    String libEntete[] = {"id","daty","etat","remarque","designation","modepaiementlib","idMagasinLib","idclientlib","reference"};
...
<div class="box-body">
  <%  String libEnteteAffiche[] = {"Id","Date","&Eacute;tat","Remarque","D&eacute;signation","Mode paiement","Magasin","Client","R&eacute;f&eacute;rence"};
